...
public class Config {
    ...
    public static final double INITIAL_ENERGY_ANIMAL = 50;
    public static final double INITIAL_RADIUS_ANIMAL = 10;
    ...
    public static final double PREY_EATING_PLANT_RATIO = 0.25;
    ...
    public static final double PLANT_GROWTH = 0.25;

    public static final double HEALTH_PER_AREA = 0.3;
    public static final double ENERGY_PER_AREA = 0.3;
    public static final double HUNGER_PER_AREA = 0.0003; //0.00015
    public static final double HUNGER_DAMAGE_PER_AREA = 0.0015; //0.00075

    public static final double ENERGY_PER_DISTANCE = 0.01; //0.05
